...
To Run the project from command line - Run below command from project folder
    ...
    for example : ant run -Darg0="https://mirrors.estointernet.in/apache/ant/binaries/" -Darg1="file.html"
...
STEP 2: To Run Built Jar - Go to Built Jar folder -> open cmd terminal -> run below command
    java -jar <jar-name> "give URL as input" "File name like file.html"
